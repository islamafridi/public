...
?>
<div class="toolbar">
	<div><button class="btn btn-sm catsmenu_btn xsmf" type="button"><span class="uppercase fbold"><?php the_archive_title(); ?></span></button>
</div>
<div class="wrp">
...
<div class="page">
	<div class="wrp">
		...
		<div class="colomns">
			<div class="content">
				<?php
				if(function_exists('archive_top_ad')) archive_top_ad(); if( have_posts() ) : ?>
				<div class="post_list">
					<?php
