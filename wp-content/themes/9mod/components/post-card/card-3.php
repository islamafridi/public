...
// Define the variable earlier in the code
...
?>
  ...
  <a href="<?php the_permalink(); ?>" class="card" title="<?php echo $app_name; ?>">
    <div class="thumb">
      <img class="blur-up lazyload" src="<?php the_post_thumbnail_url(); ?>" alt="<?php echo $app_name; ?>" loading="lazy">
      <div class="mod-badge">
